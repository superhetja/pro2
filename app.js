function doAjax() {
    ...
    axios.post(url, { difficulty: paramValue })
        ...
        .catch(function (error) {
            ...
            if (paramValue == "easy") {
                board ==[["5","6","4",".",".","3","2",".","1"],["8","7","2",".","1",".","3","9","."],["3","9","1",".",".",".",".",".","5"],["4","2","9","6","5","7","3","1","8"],[".",".","8","2","3","1","9","4","7"],["7","1","3","8","4","9","5","2","6"],[".",".","6",".","3","5","8","4","2"],["4","2","3","7","8","9","1",".","."],[".","5","8","2","6","4","9","3","7"]]
            }
            else if (paramValue == "medium") {
                board ==[["8","7",".",".","4",".","6","2","5"],["4","5",".",".","2",".",".","1","."],["2","1",".","8","5",".",".","9","."],["7","6",".","5",".","4",".","8","."],["9","3","1","8","6","2","5",".","7"],["5","4","8","3",".","1","9","6","2"],["2",".","7","9","5","8","4",".","6",],[".","9","4","6","7","3","2",".","5"],[".",".","5","1",".","4",".",".","."]]
            }
            else if (paramValue == "hard") {
                board ==[["4",".",".","9",".",".",".",".","."][".",".",".",".","4",".",".",".","."],["5","3","9","6",".","1","7",".","4"],[".","9","6",".","4","7",".",".","."],[".","7","8","5",".","2","1","9","6"],["2","5","3","9","1","6","8","4","7"],[".",".","1",".","8","4","2",".","."],[".","8",".",".",".",".",".","5","4"],["4",".","2","3",".","5","1","7","8"]]
            }
            console.log(error);
        })
        .then(function () {
...
function validateBoard(){
    ...
    for(i=0; i < 9; i++) {
        ...
        for(n=0; n < 9; n++){
            ...
            if(cell.className == "input_field" && cell.value.length == 0){
                console.log("inside if")
                cell.className = "empty_cell";
            }
            line.push(document.getElementById(cell_name).value)
        }
        full_sudoku.push(line)
        console.log(full_sudoku)
    }
